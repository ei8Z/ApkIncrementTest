...
#include "com_yiyicai_tvtrendapp_apkincrementtest_bsdiff_DiffUtils.h"
...
JNIEXPORT jint JNICALL Java_com_yiyicai_tvtrendapp_apkincrementtest_bsdiff_DiffUtils_genDiff(JNIEnv *env,
